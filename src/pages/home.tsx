...
export default function Home() {
  ...
  const handleAddToCart = (producto: any) => {
    addToCart(producto);
    navigate("/cart"); // 👉 después de agregar, manda al carrito
  };
        ...
        {productos.map((prod) => (
          ...
          >
            ...
            <button
              ...
              className="mt-5 bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-6 py-2 rounded-full shadow-lg hover:from-indigo-600 hover:to-blue-500 transition-all duration-300"
            >
              Agregar al carrito
            </button>
          </div>
