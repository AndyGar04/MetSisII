            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {productosFiltrados.map((p) => (
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm mb-1">Stock: {p.cantidad}</p>
                  <p className="text-indigo-600 font-bold text-lg">${p.precio.toLocaleString()}</p>
                  <button
                  ...
                  >
                    {p.cantidad === 0 ? "Sin Stock" : "Agregar al carrito"}
                  </button>
                </div>
              ))}
            </div>
